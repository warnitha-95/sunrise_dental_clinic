...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="<%= request.getContextPath() %>/managePatients"
               class="active">
...
<div class="main-content">
    ...
    <section class="page-heading">
        ...
        <div class="heading-content">
            ...
            <div>
                ...
                <p>
                    View, search, update and manage registered patients.
                </p>
    ...
    <section class="patient-panel">
        ...
        <div class="search-area">
            ...
            <form action="<%= request.getContextPath() %>/managePatients"
                  method="get"
                  class="search-form">
            ...
            <table class="patient-table">
                ...
                <tr class="patient-row">
                    ...
                    <td>
                        ...
                        <a class="phone-link"
                           href="tel:<%= pat.getContact_number() %>">
                    ...
                    <td>
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="<%= request.getContextPath() %>/updatePatients?patient_id=<%= pat.getPatient_id() %>"
                            ...
                            <button type="button"
                                    ...
                                    onclick="confirmDelete('<%= pat.getPatient_id() %>', '<%= pat.getPatient_name().replace("'", "\\'") %>')">
...
function confirmDelete(patientId, patientName) {
    ...
    deleteLink.href =
        "<%= request.getContextPath() %>/deletePatients?patient_id="
